...
def test_get_intf_ip_from_files_yield_value():
    ...
    correct_value = {'Ethernet0/0': ('10.0.13.1', '255.255.255.0'),
                     'Ethernet0/2': ('10.0.19.1', '255.255.255.0'),
                     'Loopback0': ('10.1.1.1', '255.255.255.255')}
    assert first_dict['PE_r1'] == correct_value, "Функция вернула неправильный результат"
...
def test_get_intf_ip_from_files_new_file(tmpdir):
    ...
    config2 = (
        ...
        '!\n')
    correct_results = [
        {'LONDON-1': {'Loopback0': ('192.168.10.1', '255.255.255.255'),
                      'Ethernet0/2': ('192.168.20.1', '255.255.255.0')}},
        {'LONDON-2': {'Ethernet0/1': ('10.1.2.1', '255.255.255.0'),
