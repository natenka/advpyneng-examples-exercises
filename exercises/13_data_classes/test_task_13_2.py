...
def test_class_created():
    ...
    assert hasattr(task_13_2.IPAddress, "__dataclass_params__"), "Класс надо создать с помощью dataclass"
...
def test_method__add__():
    ...
    assert isinstance(sum_ip, task_13_2.IPAddress), "Метод __add__ должен возвращать новый экземпляр класса IPAddress"
